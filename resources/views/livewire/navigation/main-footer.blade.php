    ...
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10">
        <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
            <div class="col-span-2">
                ...
                <p class="my-4 font-light text-gray-500 dark:text-gray-400">Flowbite is a open-source library of
                    over 400+ web components and interactive elements built with the utility classes from Tailwind
                    CSS.</p>
                <ul class="flex mt-5 space-x-6">
                    <li>
                        <a href="#"
                            class="text-gray-500  hover:text-primary-700 dark:hover:text-white dark:text-gray-400">
            ...
            <div class="lg:mx-auto">
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Careers</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Brand Center</a>
                    </li>
                    <li class="mb-4">
            ...
            <div class="lg:mx-auto">
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Discord Server</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Twitter</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Facebook
                    </li>
                    <li class="mb-4">
            ...
            <div class="lg:mx-auto">
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Privacy Policy</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Licensing</a>
                    </li>
                    <li class="mb-4">
            ...
            <div class="lg:mx-auto">
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">iOS</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Android</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">Windows</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:text-primary-700">MacOS</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 <a href="#"
                class="hover:text-primary-700">Flowbite™</a>. All Rights Reserved.</span>
    </div>
</footer>
