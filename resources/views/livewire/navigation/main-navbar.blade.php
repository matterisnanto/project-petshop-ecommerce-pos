    ...
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center lg:space-x-2">
                <!-- Cart Dropdown -->
                <button wire:click="$toggle('showCartDropdown')" type="button"
                    ...
                    <span
                        class="hidden sm:flex ms-1 bg-primary-600 text-white text-xs font-semibold px-2 py-0.5 rounded-full">
                        {{ $totalItems }}
                    </span>
                </button>

                <!-- Cart Dropdown Content -->
                @if ($showCartDropdown ?? false)
                    <div class="absolute z-10 mt-2 w-72 sm:w-96 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-800 dark:ring-gray-600"
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-600 pt-2">
                                <p class="text-sm font-semibold text-gray-900 dark:text-white text-right">
                ...
                <!-- User Dropdown -->
                <button wire:click="$toggle('showUserDropdown')" type="button"
                    class="inline-flex items-center rounded-lg justify-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm font-medium leading-none text-gray-900 dark:text-white">
                ...
                @if ($showUserDropdown ?? false)
                    <div class="absolute z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-700 dark:ring-gray-600"
                        style="right: 1rem; top: 4.5rem;">
                        ...
                        <div
                            class="p-2 text-sm font-medium text-gray-900 dark:text-white border-t border-gray-200 dark:border-gray-600">
                            <a href="#" title=""
                                class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                Sign Out </a>
                        </div>
                ...
                <!-- Mobile Menu Button -->
                <button wire:click="$toggle('showMobileMenu')" type="button"
        ...
        @if ($showMobileMenu ?? false)
            <div
                class="bg-gray-50 dark:bg-gray-700 dark:border-gray-600 border border-gray-200 rounded-lg py-3 px-4 mt-4">
