            ...
            <div class="grid gap-8 mb-8 xl:grid-cols-3">
                @foreach ($breedings as $breeding)
                    ...
                    <div
                        ...
                        <h3 class="mb-4 text-2xl font-semibold">{{ $breeding->name }}</h3>
                        <p class="text-gray-500 text-light sm:text-lg dark:text-gray-400">{{ $breeding->description }}
                        </p>

                        @foreach ($breeding->breedingPackage as $package)
                            <div class="flex justify-center items-baseline my-4">
                                <span
                                    class="mr-2 text-3xl font-extrabold">Rp{{ number_format($breeding->selling_price, 0, ',', '.') }}</span>
