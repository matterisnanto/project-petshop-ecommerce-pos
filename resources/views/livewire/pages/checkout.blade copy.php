    ...
    <section class="bg-white py-2 antialiased dark:bg-gray-900 md:py-4">
        <form class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                <!-- Left Column - Shipping Details and Delivery Methods -->
                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                    <div class="space-y-6">
                        <!-- Shipping Details Section -->
                        <div
                            class="relative rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                            <div class="space-y-4">
                                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Shipping Details</h2>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div x-data="{ open: false }" class="relative">
                                            <input type="text" id="address-search"
                                                wire:model.live="addressSearchQuery" @focus="open = true"
                                                @click.away="open = false"
                                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                                placeholder="Please enter your district/village and select" />

                                            <div x-show="open"
                                                class="absolute z-10 mt-1 w-full rounded-md bg-white shadow-lg dark:bg-gray-800">
                                                <ul class="max-h-60 overflow-auto py-1">
                                                    ...
                                                    @else
                                                        @forelse($addressSearchResults as $value => $label)
                                                            <li wire:click="selectAddress('{{ $value }}')"
                                                                class="cursor-pointer px-3 py-2 text-sm text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                                                {{ $label }}
                                                            </li>
                                                        @empty
                                                            <li
                                                                class="px-3 py-2 text-sm text-gray-500 dark:text-gray-400">
                                                                @if (strlen($addressSearchQuery) >= 3)
                                                                    No addresses found
                                                                @else
                                                                    loading......
                                                                @endif
