        ...
        <div class="mx-auto grid max-w-screen-xl  px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
            ...
            <div class="content-center justify-self-start md:col-span-7 md:text-start">
                ...
                <a wire:navigate href="/products"
                    class="inline-block rounded-lg bg-primary-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-600 dark:focus:ring-primary-800">
                    Shop Now
                </a>
            </div>
            ...
            <div class="hidden md:col-span-5 md:mt-0 md:flex">
                ...
                <img class="hidden dark:block" src="{{ url('/img/Catanddog-amico.png') }}"
        ...
        <div class="py-4 lg:py-8 px-4 mx-auto max-w-screen-xl">
            ...
            <div class="relative md:hidden mt-2" data-carousel="static">
                ...
                <div class="relative h-64 overflow-hidden rounded-lg"> <!-- Tinggi carousel disesuaikan -->
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <a href="#"
                            class="flex justify-center items-center h-full p-4 text-center bg-gray-50 rounded hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800">
                            <img src="https://petshopindonesia.com/wp-content/uploads/2022/12/hills-logo.svg"
                                alt="Hills" class="w-48 h-32 object-contain"> <!-- Ukuran gambar diperbesar -->
                        </a>
                    </div>
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <a href="#"
                            class="flex justify-center items-center h-full p-4 text-center bg-gray-50 rounded hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800">
                            <img src="https://petshopindonesia.com/wp-content/uploads/2022/12/bolt-cat.svg"
                                alt="Bolt Cat" class="w-48 h-32 object-contain"> <!-- Ukuran gambar diperbesar -->
                        </a>
                    </div>
                </div>
                <!-- Slider controls -->
            ...
            <div class="hidden md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-4 xl:gap-8 md:mb-8 md:mt-12">
                ...
                <a href="#"
                    class="flex justify-center items-center p-8 text-center bg-gray-50 rounded hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800">
                    <img src="https://petshopindonesia.com/wp-content/uploads/2022/12/pedigree-logo.svg"
                        alt="Pedigree" class="h-16">
                </a>
                <a href="#"
                    class="flex justify-center items-center p-8 text-center bg-gray-50 rounded hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800">
                    <img src="https://petshopindonesia.com/wp-content/uploads/2022/12/Friskies-Logo.svg"
                        alt="Friskies" class="h-16">
                </a>
                <a href="#"
                    class="flex justify-center items-center p-8 text-center bg-gray-50 rounded hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800">
                    <img src="https://petshopindonesia.com/wp-content/uploads/2022/12/meo.svg" alt="Me-O"
