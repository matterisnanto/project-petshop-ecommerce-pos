<div>
    <div class="bg-primary-100 dark:bg-gray-800 w-full py-8">
        <div class="px-4 mx-auto max-w-screen-sm text-center lg:px-6">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pet Hotel</h2>
            <p class="font-light text-gray-600 dark:text-gray-400 sm:text-xl">Liburan tanpa khawatir, peliharaan aman dan
                nyaman! </p>
        </div>
    </div>

    <section class="bg-white dark:bg-gray-900">
        <div class="py-4 px-4 mx-auto space-y-4 max-w-screen-xl lg:space-y-20 sm:py-6 lg:px-6">
            <!-- Row -->
            <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                        Penginapan Nyaman & Aman untuk Hewan Kesayangan
                    </h2>
                    <p class="mb-2 font-light lg:text-xl">
                        Nikmati layanan Pet Hotel terbaik di CindyPetshop. Kami menyediakan fasilitas lengkap dan
                        lingkungan yang nyaman agar hewan peliharaan Anda merasa seperti di rumah sendiri.
                    </p>
                    <!-- List -->
                    <ul role="list" class="pt-2 my-4 space-y-5 border-t border-gray-200 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Kamar ber-AC dan bersih untuk kenyamanan maksimal
                            </span>
                        </li>
                        <li class="flex space-x-3">
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Jadwal makan teratur dan makanan sesuai kebutuhan
                            </span>
                        </li>
                        <li class="flex space-x-3">
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Pemantauan rutin oleh staf profesional dan penyayang hewan
                            </span>
                        </li>
                    </ul>
                    <p class="mb-2 font-light lg:text-xl">
                        Kami pastikan hewan Anda mendapatkan perhatian dan perawatan terbaik selama menginap di
                        CindyPetshop.
                    </p>
                </div>
            ...
            <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    ...
                    <p class="mb-2 font-light lg:text-xl">
                        Kami memahami bahwa setiap hewan memiliki kebutuhan berbeda. Di CindyPetshop, kami menyesuaikan
                        layanan
                        agar sesuai dengan karakter dan kebiasaan hewan kesayangan Anda.
                    </p>
                    <ul role="list" class="pt-2 my-4 space-y-5 border-t border-gray-200 dark:border-gray-700">
                        <li class="flex space-x-3">
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Laporan harian dan dokumentasi foto saat menginap
                            </span>
                        </li>
                        <li class="flex space-x-3">
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Paket penginapan sesuai ukuran dan jenis hewan
                            </span>
                        </li>
                        <li class="flex space-x-3">
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Kebersihan area terjamin dan sanitasi rutin
                            </span>
                        </li>
                        <li class="flex space-x-3">
                            <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500"
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                                Tersedia layanan tambahan seperti grooming & aktivitas harian
                            </span>
                        </li>
                    </ul>
                    <p class="font-light lg:text-xl">
                        CindyPetshop siap menjadi tempat menginap terpercaya untuk hewan kesayangan Anda kapan saja Anda
                        butuhkan.
                    </p>
                </div>
            </div>
                ...
                <div class="flex mb-2 md:flex-col md:mb-0">
                    ...
                    <div>
                        <h3 class="text-xl font-bold md:mt-4 mb-2.5 text-gray-900 dark:text-white">Tim Perawat
                            Profesional &
                            Peduli</h3>
                        <p class="text-gray-500 dark:text-gray-400">Tim kami terdiri dari pecinta hewan yang terlatih
                            untuk
                            merawat dan memperhatikan setiap kebutuhan hewan Anda selama menginap.</p>
                    </div>
                </div>
                <div class="flex mb-2 md:flex-col md:mb-0">
                    ...
                    <div>
                        <h3 class="text-xl font-bold md:mt-4 mb-2.5 text-gray-900 dark:text-white">Fasilitas Nyaman &
                            Terjaga</h3>
                        <p class="text-gray-500 dark:text-gray-400">Ruang inap bersih, luas, dan aman dengan ventilasi
                            baik,
                            memastikan hewan kesayangan Anda tetap nyaman dan tenang selama ditinggal.</p>
                    </div>
                </div>
                <div class="flex md:flex-col">
                    ...
                    <div>
                        <h3 class="text-xl font-bold md:mt-4 mb-2.5 text-gray-900 dark:text-white">Monitoring &
                            Komunikasi</h3>
                        <p class="text-gray-500 dark:text-gray-400">Kami menyediakan update harian berupa foto/video
                            serta
                            laporan singkat agar Anda tenang dan tahu kondisi hewan kesayangan kapan saja.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                    Kami Lebih dari Sekadar Pet Hotel
                </h2>
                <p class="text-lg text-gray-600 dark:text-gray-300">
                    Di CindyPetHotel, kami adalah pecinta hewan, pengasuh profesional, dan keluarga kedua yang penuh
                    kasih
                    untuk hewan kesayangan Anda. Perpaduan antara kenyamanan, keamanan, dan perhatian membuat kami jadi
                    pilihan utama para pemilik hewan.
                </p>
            </div>
    ...
    <div class="mt-4 p-5 bg-primary-100 mx-auto max-w-screen text-center mb-2 lg:mb-6">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
            Paket Menginap Nyaman untuk Hewan Kesayangan Anda
        </h2>
        <p class=" font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Di Cindy PetHotel, kami menyediakan penginapan premium dengan fasilitas lengkap dan perawatan penuh kasih,
            untuk anjing dan kucing kesayangan Anda saat Anda berpergian.
        </p>
    </div>
            ...
            <div class="grid gap-8 mb-8 xl:grid-cols-3">
                @foreach ($hotels as $hotel)
                    <div
                        ...
                        <h3 class="mb-4 text-2xl font-semibold">{{ $hotel->name }}</h3>
                        <p class="text-gray-500 text-light sm:text-lg dark:text-gray-400">{{ $hotel->description }}
                        </p>

                        <div class="flex justify-center items-baseline my-4">
                            <span
                                class="mr-2 text-3xl font-extrabold">Rp{{ number_format($hotel->price_per_day, 0, ',', '.') }}</span>
                            <span class="text-gray-500">/day</span>
                        </div>

                        @foreach ($hotel->hotelPackage as $package)
                            <ul role="list" class="mb-4 space-y-2 text-left">
                                @foreach (explode("\n", $package->name) as $feature)
                                    @if (trim($feature))
                        ...
                        <a href="https://wa.me/628123456789?text=Saya%20tertarik%20dengan%20pet%20hotel%20{{ urlencode($hotel->name) }}"
                            class="mt-auto inline-flex items-center justify-center text-white bg-[#25D366] hover:bg-[#19bd56] focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
