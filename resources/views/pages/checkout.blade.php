        ...
        <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                <div class="min-w-0 flex-1 space-y-8">
                    <div class="space-y-4">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Rincian Pengiriman</h2>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <button id="dropdown-phone-button-3" data-dropdown-toggle="dropdown-phone-3"
                                        ...
                                        type="button">
                                        <svg fill="none" aria-hidden="true" class="me-2 h-4 w-4" viewBox="0 0 36 36">
                            ...
                            <div>
                                <div class="mb-2 flex items-center gap-2">
                                    <label for="select-province-input"
                                        class="block text-sm font-medium text-gray-900 dark:text-white"> Provinsi </label>
                                </div>
                            ...
                            <div>
                                <div class="mb-2 flex items-center gap-2">
                                    <label for="select-city-input"
                                        class="block text-sm font-medium text-gray-900 dark:text-white"> Kota/Kabupaten
                                    </label>
                                </div>
                            ...
                            <div>
                                <div class="mb-2 flex items-center gap-2">
                                    <label for="select-district-input"
                                        class="block text-sm font-medium text-gray-900 dark:text-white"> Kecamatan
                                    </label>
                                </div>
                            ...
                            <div>
                                <div class="mb-2 flex items-center gap-2">
                                    <label for="select-subdistrict-input    "
                                        class="block text-sm font-medium text-gray-900 dark:text-white"> Kelurahan/Desa
                                    </label>
                                </div>
                            ...
                            <div>
                                <label for="detail-address"
                                    class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Detail Alamat
                                </label>
                                <input type="text" id="detail-address"
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                    placeholder="Masukan RT/RW, Alamat Detail, Patokan Rumah" required />
                            </div>
