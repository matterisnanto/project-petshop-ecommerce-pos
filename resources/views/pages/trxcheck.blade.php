    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-md text-center">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Periksa Trx Id Disini
                </h2>
                <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Trx ID (Transaction ID) adalah kode
                    unik yang diberikan setelah sebuah transaksi berhasil dilakukan. Kode ini berfungsi sebagai identifikasi
                    transaksi yang dapat digunakan untuk melacak, memverifikasi, atau mengecek status transaksi tersebut.
                </p>
                <form action="{{ route('transaction.search') }}" method="POST" class="mx-auto max-w-screen-sm">
                    @csrf
        ...
        <div class="relative p-4 w-full max-w-xl">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex flex-col items-center text-center">
                    <img src="{{ asset('img/kucing-cape.png') }}" alt="Kucing Cape" class="w-full mb-4">
    ...
    @if (session('transaction'))
        ...
        <div class="bg-primary-100 dark:bg-gray-800 w-full py-8">
            <div class="px-4 mx-auto max-w-screen-sm text-center lg:px-6">
                ...
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Informasi Pesanan dengan kode
                    Trx Id
                    #{{ $transaction->trx_id }}</h2>
    ...
    @if (session('error'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Tampilkan modal hanya jika ada session error
